...
field_m2m = ["message_partner_ids", "route_ids", "supplier_taxes_id", "taxes_id"]
...
field_list_check = [x for x in field_use_check if x not in field_no_fiend]

field_ignore = field_system + field_error + field_no_used

field_special = field_o2m + field_m2m
